...
public class BoolSampleItemProvider extends SampleItemProvider {
     ...
     * @generated
     */
    public BoolSampleItemProvider(final AdapterFactory adapterFactory) {
    ...
    /**
     * This returns BoolSample.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/BoolSample"));
    }
    ...
    public String getText(final Object object) {
        final BoolSample boolSample = (BoolSample) object;
        return this.getString("_UI_BoolSample_type") + " " + boolSample.getProbability();
    }
