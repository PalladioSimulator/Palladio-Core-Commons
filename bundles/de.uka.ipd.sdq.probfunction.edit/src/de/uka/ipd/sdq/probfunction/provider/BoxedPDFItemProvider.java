...
public class BoxedPDFItemProvider extends ProbabilityDensityFunctionItemProvider {
     ...
     * @generated
     */
    public BoxedPDFItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ProbfunctionPackage.Literals.BOXED_PDF__SAMPLES);
        }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/BoxedPDF"));
    }
    ...
    public String getText(final Object object) {
        return this.getString("_UI_BoxedPDF_type");
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ProbfunctionPackage.Literals.BOXED_PDF__SAMPLES,
