...
public class DoubleSampleItemProvider extends SampleItemProvider {
     ...
     * @generated
     */
    public DoubleSampleItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/DoubleSample"));
    }
    ...
    public String getText(final Object object) {
        final DoubleSample doubleSample = (DoubleSample) object;
        return this.getString("_UI_DoubleSample_type") + " " + doubleSample.getProbability();
    }
