    ...
    protected void addAlphaPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors
                .add(this.createItemPropertyDescriptor(
                        ...
                        this.getString("_UI_GammaDistribution_alpha_feature"),
                        this.getString("_UI_PropertyDescriptor_description", "_UI_GammaDistribution_alpha_feature",
    ...
    protected void addThetaPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors
                .add(this.createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                        this.getResourceLocator(),
                        this.getString("_UI_GammaDistribution_theta_feature"),
                        this.getString("_UI_PropertyDescriptor_description", "_UI_GammaDistribution_theta_feature",
                                "_UI_GammaDistribution_type"),
