...
public class GammaDistributionFromMomentsImpl extends GammaDistribution {
    ...
    /**
     * Calculate alpha from mean and variance. mean = alpha*theta
     * 
     * alpha = mean/theta
     * 
     * @param mean
    ...
    /**
     * Calculate theta from mean and variance. variance = alpha*theta2 alpha = mean/theta variance =
     * mean*theta theta = variance/mean
     * 
     * @param mean
     *            The mean value
     * @param variance
