...
public class LognormalDistributionFromMomentsImpl extends LognormalDistributionImpl {
    ...
    /**
     * Calculate mu from mean and variance. u=e^(M+S^2 /2) M=ln(u)-S^2/2
     * 
     * @param mean
     *            The mean value
     * @param var
     ...
     * 
     * for x = sigma^2 and M=ln(u)-S^2/2
     * 
     * o^2 = e^(x+2M)*(e^x-1) u^2*e^3x/2 = o^2+u^2*e^x/2 e^x*e^x/2 = o^2/u^2 + e^x/2 x=ln(o^2/u^2
     * +1)
     * 
     * @param mean
     *            The mean value
