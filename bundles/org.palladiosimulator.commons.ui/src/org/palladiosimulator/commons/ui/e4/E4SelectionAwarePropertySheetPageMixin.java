...
public interface E4SelectionAwarePropertySheetPageMixin extends ISelectionListener {   
    ...
    default void setSelection(MPart activePart, Object selection) {
        ...
        if (isInitialized() && activePart != null && (activePart == viewPart || (activePart.getTransientData().containsKey(E4PartWrapper.E4_WRAPPER_KEY) 
                && activePart.getTransientData().get(E4PartWrapper.E4_WRAPPER_KEY) == viewPart))) {
            if (selection == null) {
