...
public class IdentifierPackageImpl extends EPackageImpl implements IdentifierPackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link IdentifierPackage#eINSTANCE} when that field is
    ...
    public static IdentifierPackage init() {
        ...
        IdentifierPackageImpl theIdentifierPackage = (IdentifierPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof IdentifierPackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI) : new IdentifierPackageImpl());
