...
public class ComplexItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(final Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addRealPropertyDescriptor(object);
            this.addImaginaryPropertyDescriptor(object);
        }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Complex"));
    }
    ...
    public String getText(final Object object) {
        ...
        return this.getString("_UI_Complex_type") + " " + complex.getReal();
    }
