...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.probfunction.NormalDistribution}
...
public class NormalDistributionItemProvider extends ContinuousPDFItemProvider {
     ...
     * @generated
     */
    public NormalDistributionItemProvider(final AdapterFactory adapterFactory) {
    ...
    protected void addMuPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors
                .add(this.createItemPropertyDescriptor(
                        ...
                        this.getString("_UI_NormalDistribution_mu_feature"),
                        this.getString("_UI_PropertyDescriptor_description", "_UI_NormalDistribution_mu_feature",
    ...
    protected void addSigmaPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors
                .add(this.createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                        this.getResourceLocator(),
                        this.getString("_UI_NormalDistribution_sigma_feature"),
                        this.getString("_UI_PropertyDescriptor_description", "_UI_NormalDistribution_sigma_feature",
                                "_UI_NormalDistribution_type"),
    ...
    /**
     * This returns NormalDistribution.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/NormalDistribution"));
    }
    ...
    public String getText(final Object object) {
        final NormalDistribution normalDistribution = (NormalDistribution) object;
        return this.getString("_UI_NormalDistribution_type") + " " + normalDistribution.getMu();
    }
