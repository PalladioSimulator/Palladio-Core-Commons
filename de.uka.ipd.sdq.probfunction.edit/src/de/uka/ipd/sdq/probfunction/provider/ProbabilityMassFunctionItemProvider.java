...
public class ProbabilityMassFunctionItemProvider extends ProbabilityFunctionItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(final Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addOrderedDomainPropertyDescriptor(object);
        }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ProbfunctionPackage.Literals.PROBABILITY_MASS_FUNCTION__SAMPLES);
        }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ProbabilityMassFunction"));
    }
