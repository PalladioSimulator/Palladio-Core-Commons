...
public class ProbfunctionItemProviderAdapterFactory extends ProbfunctionAdapterFactory implements
    ...
    public void dispose() {
        if (boxedPDFItemProvider != null)
            boxedPDFItemProvider.dispose();
        if (continuousSampleItemProvider != null)
            continuousSampleItemProvider.dispose();
        if (probabilityMassFunctionItemProvider != null)
            probabilityMassFunctionItemProvider.dispose();
        if (sampleItemProvider != null)
            sampleItemProvider.dispose();
        if (samplePDFItemProvider != null)
            samplePDFItemProvider.dispose();
        if (complexItemProvider != null)
        ...
        if (intSampleItemProvider != null)
            intSampleItemProvider.dispose();
        if (boolSampleItemProvider != null)
            boolSampleItemProvider.dispose();
        if (doubleSampleItemProvider != null)
            doubleSampleItemProvider.dispose();
        if (stringSampleItemProvider != null)
            stringSampleItemProvider.dispose();
    }
