...
public class ProductExpressionItemProvider extends ProductItemProvider {
     ...
     * @generated
     */
    public ProductExpressionItemProvider(final AdapterFactory adapterFactory) {
    ...
    protected void addOperationPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_ProductExpression_operation_feature"), this.getString(
                        "_UI_PropertyDescriptor_description", "_UI_ProductExpression_operation_feature",
                        "_UI_ProductExpression_type"), StoexPackage.Literals.PRODUCT_EXPRESSION__OPERATION, true,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(StoexPackage.Literals.PRODUCT_EXPRESSION__LEFT);
            this.childrenFeatures.add(StoexPackage.Literals.PRODUCT_EXPRESSION__RIGHT);
        }
    ...
    /**
     * This returns ProductExpression.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ProductExpression"));
    }
    ...
    public String getText(final Object object) {
        final ProductOperations labelValue = ((ProductExpression) object).getOperation();
        final String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? this.getString("_UI_ProductExpression_type") : this
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(StoexPackage.Literals.PRODUCT_EXPRESSION__LEFT,
        ...
        newChildDescriptors.add(this.createChildParameter(StoexPackage.Literals.PRODUCT_EXPRESSION__RIGHT,
                StoexFactory.eINSTANCE.createVariable()));
    ...
    public String getCreateChildText(final Object owner, final Object feature, final Object child,
        ...
        final boolean qualify = childFeature == StoexPackage.Literals.PRODUCT_EXPRESSION__LEFT
