 ...
 * @generated
 */
public class BaseUnitItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_BaseUnit_type") : getString("_UI_BaseUnit_type")
                + " " + label;
    }
