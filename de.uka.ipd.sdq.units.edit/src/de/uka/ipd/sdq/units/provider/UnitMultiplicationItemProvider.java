...
public class UnitMultiplicationItemProvider extends UnitItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(UnitsPackage.Literals.UNIT_MULTIPLICATION__UNITS);
        }
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/UnitMultiplication"));
    }
    ...
    public String getText(final Object object) {
        return this.getString("_UI_UnitMultiplication_type");
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(UnitsPackage.Literals.UNIT_MULTIPLICATION__UNITS,
