...
public class UnitsActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                UnitsActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        @Override
        public void run() {
            if (UnitsActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) UnitsActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        this.createSiblingMenuManager = new MenuManager(
                UnitsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
