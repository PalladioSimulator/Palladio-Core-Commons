...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Unit Literal</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class UnitLiteralImpl extends UnitImpl implements UnitLiteral {
        ...
        if (baseUnit != null && ((EObject) baseUnit).eIsProxy()) {
            ...
            if (baseUnit != oldBaseUnit) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.UNIT_LITERAL__BASE_UNIT,
    ...
    public void setBaseUnit(BaseUnit newBaseUnit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, UnitsPackage.UNIT_LITERAL__BASE_UNIT, oldBaseUnit,
                    baseUnit));
    }
