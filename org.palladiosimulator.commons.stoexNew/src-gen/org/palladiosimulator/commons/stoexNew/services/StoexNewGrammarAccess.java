 ...
 */
package org.palladiosimulator.commons.stoexNew.services;
...
@Singleton
public class StoexNewGrammarAccess extends AbstractGrammarElementFinder {
	
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.expression");
	...
	public class IfelseExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ifelseExpr");
	...
	public class BooleanExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.BooleanExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BoolAndExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.boolAndExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cBoolOrExprParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Action cBooleanOperatorExpressionLeftAction_1_0 = (Action)cGroup_1.eContents().get(0);
	...
	public class BoolOrExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.boolOrExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CompareExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.compareExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SumExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.sumExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ProdExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.prodExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PowExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.powExpr");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UnaryExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.unaryExpr");
	...
	public class NotExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.NotExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NegativeExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.NegativeExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AtomElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.atom");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class DoubleLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.DoubleLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ProbabilityFunctionLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ProbabilityFunctionLiteral");
	...
	public class ParenthesisElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.Parenthesis");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FunctionLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.FunctionLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.Variable");
	...
	public class AbstractNamedReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.AbstractNamedReference");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class VariableReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.VariableReference");
	...
	public class NamespaceReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.NamespaceReference");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BoolLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.BoolLiteral");
	...
	public class StringLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.StringLiteral");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class IntLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.IntLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValueAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class UnitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.Unit");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class UnitDivElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.unitDiv");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UnitMultiElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.unitMulti");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cUnitPowParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
	...
	public class UnitPowElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.unitPow");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BaseUnitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.BaseUnit");
	...
	public class DefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.definition");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ProbabilityDensityFunctionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ProbabilityDensityFunction");
	...
	public class BoxedPDFElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.BoxedPDF");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ProbabilityMassFunctionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ProbabilityMassFunction");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class Numeric_int_sampleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.numeric_int_sample");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLPARENTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
	...
	public class Numeric_real_sampleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.numeric_real_sample");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLPARENTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
	...
	public class Real_pdf_sampleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.real_pdf_sample");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLPARENTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cValueSIGNED_NUMBERParserRuleCall_1_0 = (RuleCall)cValueAssignment_1.eContents().get(0);
	...
	public class StringsampleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.stringsample");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLPARENTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
	...
	public class BoolsampleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.boolsample");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cLPARENTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
	...
	public class SIGNED_NUMBERElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.SIGNED_NUMBER");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cHyphenMinusKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class SIGNED_INTElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.SIGNED_INT");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cHyphenMinusKeyword_0 = (Keyword)cGroup.eContents().get(0);
	...
	public class BooleanOperationsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.BooleanOperations");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class AndoperationElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.andoperation");
	...
	public class OroperationsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.oroperations");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class CompareOperationsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.CompareOperations");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class TermOperationsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.TermOperations");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ProductOperationsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ProductOperations");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class UnitNamesElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.UnitNames");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	@Inject
	public StoexNewGrammarAccess(GrammarProvider grammarProvider) {
		...
		this.tDOUBLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.DOUBLE");
		this.tDECINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.DECINT");
		this.tBOOLEAN_KEYWORDS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.BOOLEAN_KEYWORDS");
		this.tNOT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.NOT");
		this.tINTPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.INTPMF");
		this.tDOUBLEPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.DOUBLEPMF");
		this.tENUMPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ENUMPMF");
		this.tDOUBLEPDF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.DOUBLEPDF");
		this.tBOOLPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.BOOLPMF");
		this.tPOW = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.POW");
		this.tLPAREN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.LPAREN");
		this.tRPAREN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.RPAREN");
		this.tSEMI = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.SEMI");
		this.tCOLON = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.COLON");
		this.tORDERED_DEF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ORDERED_DEF");
		this.tSQUARE_PAREN_L = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.SQUARE_PAREN_L");
		this.tSQUARE_PAREN_R = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.SQUARE_PAREN_R");
		this.tDIGIT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.DIGIT");
		this.tDOT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.DOT");
		this.tCONDDELIMITER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.CONDDELIMITER");
		this.tELSEDELIMITER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ELSEDELIMITER");
		this.tID = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ID");
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.STRING");
		this.tML_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ML_COMMENT");
		this.tSL_COMMENT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.SL_COMMENT");
		this.tWS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.WS");
		this.tANY_OTHER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.palladiosimulator.commons.stoexNew.StoexNew.ANY_OTHER");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("org.palladiosimulator.commons.stoexNew.StoexNew".equals(grammar.getName())) {
				return grammar;
			}
