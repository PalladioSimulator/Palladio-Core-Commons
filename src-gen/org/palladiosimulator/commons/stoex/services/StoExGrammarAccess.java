...
public class StoExGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProbabilityFunctionLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ProbabilityFunctionLiteral");
	...
	public class AbstractNamedReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AbstractNamedReference");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ProbabilityDensityFunctionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ProbabilityDensityFunction");
	...
	private IfelseExprElements pIfelseExpr;
	private BooleanExpressionElements pBooleanExpression;
	private BooleanOperationsElements unknownRuleBooleanOperations;
	private BoolAndExprElements pBoolAndExpr;
	private AndoperationElements unknownRuleAndoperation;
	private BoolOrExprElements pBoolOrExpr;
	private OroperationsElements unknownRuleOroperations;
	private CompareExprElements pCompareExpr;
	private CompareOperationsElements unknownRuleCompareOperations;
	private SumExprElements pSumExpr;
	private TermOperationsElements unknownRuleTermOperations;
	private ProdExprElements pProdExpr;
	private ProductOperationsElements unknownRuleProductOperations;
	private PowExprElements pPowExpr;
	...
	private ProbabilityFunctionLiteralElements pProbabilityFunctionLiteral;
	private ParenthesisElements pParenthesis;
	private FunctionLiteralElements pFunctionLiteral;
	private VariableElements pVariable;
	private AbstractNamedReferenceElements pAbstractNamedReference;
	private VariableReferenceElements pVariableReference;
	private NamespaceReferenceElements pNamespaceReference;
	private BoolLiteralElements pBoolLiteral;
	private StringLiteralElements pStringLiteral;
	private IntLiteralElements pIntLiteral;
	private UnitElements pUnit;
	private UnitDivElements pUnitDiv;
	private UnitMultiElements pUnitMulti;
	private UnitPowElements pUnitPow;
	private BaseUnitElements pBaseUnit;
	private UnitNamesElements unknownRuleUnitNames;
	private DefinitionElements pDefinition;
	private ProbabilityDensityFunctionElements pProbabilityDensityFunction;
	private BoxedPDFElements pBoxedPDF;
	private ProbabilityMassFunctionElements pProbabilityMassFunction;
	private Numeric_int_sampleElements pNumeric_int_sample;
	private Numeric_real_sampleElements pNumeric_real_sample;
	private Real_pdf_sampleElements pReal_pdf_sample;
	private StringsampleElements pStringsample;
	private BoolsampleElements pBoolsample;
	private SIGNED_NUMBERElements pSIGNED_NUMBER;
	private SIGNED_INTElements pSIGNED_INT;
	private TerminalRule tDOUBLE;
	private TerminalRule tDECINT;
	private TerminalRule tBOOLEAN_KEYWORDS;
	private TerminalRule tNOT;
	private TerminalRule tINTPMF;
	private TerminalRule tDOUBLEPMF;
	private TerminalRule tENUMPMF;
	private TerminalRule tDOUBLEPDF;
	private TerminalRule tBOOLPMF;
	...
	private TerminalRule tORDERED_DEF;
	private TerminalRule tSQUARE_PAREN_L;
	private TerminalRule tSQUARE_PAREN_R;
	private TerminalRule tDIGIT;
	private TerminalRule tDOT;
	private TerminalRule tCONDDELIMITER;
	private TerminalRule tELSEDELIMITER;
	...
	public IfelseExprElements getIfelseExprAccess() {
		return (pIfelseExpr != null) ? pIfelseExpr : (pIfelseExpr = new IfelseExprElements());
	}
	...
	public BooleanOperationsElements getBooleanOperationsAccess() {
		return (unknownRuleBooleanOperations != null) ? unknownRuleBooleanOperations : (unknownRuleBooleanOperations = new BooleanOperationsElements());
	}
	...
	public BoolAndExprElements getBoolAndExprAccess() {
		return (pBoolAndExpr != null) ? pBoolAndExpr : (pBoolAndExpr = new BoolAndExprElements());
	}
	...
	public AndoperationElements getAndoperationAccess() {
		return (unknownRuleAndoperation != null) ? unknownRuleAndoperation : (unknownRuleAndoperation = new AndoperationElements());
	}
	...
	public BoolOrExprElements getBoolOrExprAccess() {
		return (pBoolOrExpr != null) ? pBoolOrExpr : (pBoolOrExpr = new BoolOrExprElements());
	}
	...
	public OroperationsElements getOroperationsAccess() {
		return (unknownRuleOroperations != null) ? unknownRuleOroperations : (unknownRuleOroperations = new OroperationsElements());
	}
	...
	public CompareExprElements getCompareExprAccess() {
		return (pCompareExpr != null) ? pCompareExpr : (pCompareExpr = new CompareExprElements());
	}
	...
	public CompareOperationsElements getCompareOperationsAccess() {
		return (unknownRuleCompareOperations != null) ? unknownRuleCompareOperations : (unknownRuleCompareOperations = new CompareOperationsElements());
	}
	...
	public SumExprElements getSumExprAccess() {
		return (pSumExpr != null) ? pSumExpr : (pSumExpr = new SumExprElements());
	}
	...
	public TermOperationsElements getTermOperationsAccess() {
		return (unknownRuleTermOperations != null) ? unknownRuleTermOperations : (unknownRuleTermOperations = new TermOperationsElements());
	}
	...
	public ProdExprElements getProdExprAccess() {
		return (pProdExpr != null) ? pProdExpr : (pProdExpr = new ProdExprElements());
	}
	...
	public ProductOperationsElements getProductOperationsAccess() {
		return (unknownRuleProductOperations != null) ? unknownRuleProductOperations : (unknownRuleProductOperations = new ProductOperationsElements());
	}
	...
	public PowExprElements getPowExprAccess() {
		return (pPowExpr != null) ? pPowExpr : (pPowExpr = new PowExprElements());
	}
	...
	public ProbabilityFunctionLiteralElements getProbabilityFunctionLiteralAccess() {
		return (pProbabilityFunctionLiteral != null) ? pProbabilityFunctionLiteral : (pProbabilityFunctionLiteral = new ProbabilityFunctionLiteralElements());
	}
	...
	public FunctionLiteralElements getFunctionLiteralAccess() {
		return (pFunctionLiteral != null) ? pFunctionLiteral : (pFunctionLiteral = new FunctionLiteralElements());
	}
	...
	public AbstractNamedReferenceElements getAbstractNamedReferenceAccess() {
		return (pAbstractNamedReference != null) ? pAbstractNamedReference : (pAbstractNamedReference = new AbstractNamedReferenceElements());
	}
	...
	public NamespaceReferenceElements getNamespaceReferenceAccess() {
		return (pNamespaceReference != null) ? pNamespaceReference : (pNamespaceReference = new NamespaceReferenceElements());
	}
	...
	public UnitDivElements getUnitDivAccess() {
		return (pUnitDiv != null) ? pUnitDiv : (pUnitDiv = new UnitDivElements());
	}
	...
	public UnitMultiElements getUnitMultiAccess() {
		return (pUnitMulti != null) ? pUnitMulti : (pUnitMulti = new UnitMultiElements());
	}
	...
	public UnitPowElements getUnitPowAccess() {
		return (pUnitPow != null) ? pUnitPow : (pUnitPow = new UnitPowElements());
	}
	...
	public BaseUnitElements getBaseUnitAccess() {
		return (pBaseUnit != null) ? pBaseUnit : (pBaseUnit = new BaseUnitElements());
	}
	...
	public UnitNamesElements getUnitNamesAccess() {
		return (unknownRuleUnitNames != null) ? unknownRuleUnitNames : (unknownRuleUnitNames = new UnitNamesElements());
	}
	...
	public ProbabilityDensityFunctionElements getProbabilityDensityFunctionAccess() {
		return (pProbabilityDensityFunction != null) ? pProbabilityDensityFunction : (pProbabilityDensityFunction = new ProbabilityDensityFunctionElements());
	}
	...
	public Numeric_int_sampleElements getNumeric_int_sampleAccess() {
		return (pNumeric_int_sample != null) ? pNumeric_int_sample : (pNumeric_int_sample = new Numeric_int_sampleElements());
	}
	...
	public Numeric_real_sampleElements getNumeric_real_sampleAccess() {
		return (pNumeric_real_sample != null) ? pNumeric_real_sample : (pNumeric_real_sample = new Numeric_real_sampleElements());
	}
	...
	public Real_pdf_sampleElements getReal_pdf_sampleAccess() {
		return (pReal_pdf_sample != null) ? pReal_pdf_sample : (pReal_pdf_sample = new Real_pdf_sampleElements());
	}
	...
	public StringsampleElements getStringsampleAccess() {
		return (pStringsample != null) ? pStringsample : (pStringsample = new StringsampleElements());
	}
	...
	public BoolsampleElements getBoolsampleAccess() {
		return (pBoolsample != null) ? pBoolsample : (pBoolsample = new BoolsampleElements());
	}
	...
	public SIGNED_NUMBERElements getSIGNED_NUMBERAccess() {
		return (pSIGNED_NUMBER != null) ? pSIGNED_NUMBER : (pSIGNED_NUMBER = new SIGNED_NUMBERElements());
	}
	...
	public TerminalRule getDECINTRule() {
		return (tDECINT != null) ? tDECINT : (tDECINT = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "DECINT"));
	} 

	//terminal BOOLEAN_KEYWORDS returns ecore::EBoolean:
	//	"false" | "true";
	public TerminalRule getBOOLEAN_KEYWORDSRule() {
		return (tBOOLEAN_KEYWORDS != null) ? tBOOLEAN_KEYWORDS : (tBOOLEAN_KEYWORDS = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "BOOLEAN_KEYWORDS"));
	} 
	...
	public TerminalRule getINTPMFRule() {
		return (tINTPMF != null) ? tINTPMF : (tINTPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "INTPMF"));
	} 

	//terminal DOUBLEPMF:
	//	"DoublePMF";
	public TerminalRule getDOUBLEPMFRule() {
		return (tDOUBLEPMF != null) ? tDOUBLEPMF : (tDOUBLEPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "DOUBLEPMF"));
	} 

	//terminal ENUMPMF:
	//	"EnumPMF";
	public TerminalRule getENUMPMFRule() {
		return (tENUMPMF != null) ? tENUMPMF : (tENUMPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "ENUMPMF"));
	} 

	//terminal DOUBLEPDF:
	//	"DoublePDF";
	public TerminalRule getDOUBLEPDFRule() {
		return (tDOUBLEPDF != null) ? tDOUBLEPDF : (tDOUBLEPDF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "DOUBLEPDF"));
	} 

	//terminal BOOLPMF:
	//	"BoolPMF";
	public TerminalRule getBOOLPMFRule() {
		return (tBOOLPMF != null) ? tBOOLPMF : (tBOOLPMF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "BOOLPMF"));
	} 
	...
	public TerminalRule getORDERED_DEFRule() {
		return (tORDERED_DEF != null) ? tORDERED_DEF : (tORDERED_DEF = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "ORDERED_DEF"));
	} 

	//terminal SQUARE_PAREN_L:
	//	"[";
	public TerminalRule getSQUARE_PAREN_LRule() {
		return (tSQUARE_PAREN_L != null) ? tSQUARE_PAREN_L : (tSQUARE_PAREN_L = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "SQUARE_PAREN_L"));
	} 

	//terminal SQUARE_PAREN_R:
	//	"]";
	public TerminalRule getSQUARE_PAREN_RRule() {
		return (tSQUARE_PAREN_R != null) ? tSQUARE_PAREN_R : (tSQUARE_PAREN_R = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "SQUARE_PAREN_R"));
	} 
	...
	public TerminalRule getCONDDELIMITERRule() {
		return (tCONDDELIMITER != null) ? tCONDDELIMITER : (tCONDDELIMITER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "CONDDELIMITER"));
	} 

	//terminal ELSEDELIMITER:
	//	":";
	public TerminalRule getELSEDELIMITERRule() {
		return (tELSEDELIMITER != null) ? tELSEDELIMITER : (tELSEDELIMITER = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "ELSEDELIMITER"));
	} 
